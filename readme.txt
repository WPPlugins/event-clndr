=== Event CLNDR ===
Contributors: i4nd90
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=33ADSKNWT92J2
Tags: event, events, calendar, dates
...
1. Remove any shortcodes from posts/pages/widgets where Event CLNDR was displayed

== Frequently Asked Questions ==

= What options can I change when displaying the calendar? =

If you're a developer, the world is your oyster - head on over to the documentation for [CLNDR.js](https://github.com/kylestetz/CLNDR#usage "CLNDR.js"). The templating and method options can be changed on the Instances page in the plugin.
...
1. Full size calendar with event list on page/post view
2. Mini calendar with event list in a sidebar widget
3. Instance manager in admin view
4. Event manager in admin view
5. Stylesheet editor in admin view
...
== Upgrade Notice ==
Option to open event links in a new/same tab, i18n support
